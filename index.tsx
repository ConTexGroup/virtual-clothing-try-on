...
<html lang="en">
  <head>
    ...
    <title>Conbello Textile: Virtual clothing try-on</title>
  ...
  <body>
    <div id="root"></div>
    <!-- Change script type to 'text/babel' and add data-type='module' for Babel to process it -->
